...
export const GET_ANALYTICS_VIEWS = "analytics/seller";
// getRelatedItems
export const getRelatedItems = async (slug) => {
  return await axios.get(
    `${process.env.NEXT_PUBLIC_API_URL}/related-items/${slug}`
  );
};
...
export const FeaturedSectionApi = {
  getFeaturedSections: ({ city, state, country, slug } = {}) => {
...
export const analyticsApi = {
  getSellerViews: ({ seller_id } = {}) => {
    return Api.get(`${GET_ANALYTICS_VIEWS}/${seller_id}/views`);
  },
};
