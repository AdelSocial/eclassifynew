...
<form className='search_cont' onSubmit={handleSearchNav}>
 ...
 <form className='search_cont' onSubmit={handleSearchNav}>
  ...
  <button type='submit'><FaSearch size={14} /><span className='srch'>{t('search')}</span></button>
            ...
            <Drawer className='eclassify_drawer' maskClosable={false} title={< Image src={settings?.header_logo} width={137} height={92} alt="Close Icon" onErrorCapture={placeholderImage} />} onClose={handleClose} open={show} closeIcon={CloseIcon} >
